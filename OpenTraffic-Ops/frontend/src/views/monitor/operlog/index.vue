   ...
   <div class="app-container">
      ...
      <div class="table-container">
         <el-table ref="operlogRef" v-loading="loading" :data="operlogList" @selection-change="handleSelectionChange"
            ...
            <el-table-column label="操作人员" align="center" width="180" prop="operName" :show-overflow-tooltip="true"
            ...
            <el-table-column label="消耗时间" align="center" prop="costTime" width="180" :show-overflow-tooltip="true"
               sortable="custom" :sort-orders="['descending', 'ascending']">
               <template #default="scope">
